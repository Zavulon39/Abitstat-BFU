...
var ClientController = /** @class */ (function () {
    ...
    ClientController.prototype.examList2 = function (req, res) {
        var id = req.params.id;
        res.render('exam/list2', { id: id });
    };
    ClientController.prototype.examList3 = function (req, res) {
        var _a = req.params, id = _a.id, idx = _a.idx;
        res.render('exam/list3', { id: id, idx: idx });
    };
    ClientController.prototype.ratingIndex = function (req, res) {
        res.render('rating/list0');
    };
